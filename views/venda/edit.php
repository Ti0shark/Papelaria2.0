                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="date" name="data_venda" class="form-control" value="<?= $venda->getData() ?>">
                        </p>
                        <!-- Para a chave estrangeira (associação com Cliente) -->
                        <p class="form-group">
                            <label for="cliente">Id do Cliente</label>
                            <select name="cliente" class="form-control">
                                <?php foreach($daoCliente->read() as $cliente) : ?>
                                    <?php if($venda->getCliente()->getId() == $cliente->getId()) : ?>
