<?php
    ...
    $daoProdutoCompra = new ProdutoCompraDAO(); //peguei isso do github do professor e alterei pro da lolo
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    ...
                    <form action="insert.php" method="post">
                        ...
                        <p class="form-group">
                            ...
                            <select name="produto" class="form-control">
                                <?php foreach($daoProdutoCompra->read() as $produto) : ?>
                    ...
                    </form> // A linha 283 ate a 290 não sei ao certo se elas ficam aqui, devido o nosso produtocompra nao possuir nenhum desses atributos
