                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="date" name="data_compra" class="form-control" value="<?= $compra->getData() ?>">
                        </p>
                        <!-- Para a chave estrangeira (associação com Distribuidor) -->
                        <p class="form-group">
                            <label for="distribuidor">Distribuidor</label>
                            <select name="distribuidor" class="form-control">
                                <?php foreach($daoDistribuidor->read() as $distribuidor) : ?>
                                    <?php if($compra->getDistribuidor()->getId() == $distribuidor->getId()) : ?>
                                        <option selected value="<?= $distribuidor->getId() ?>"><?= $distribuidor->getEndereco() ?></option>
                                    <?php else : ?>
                                        <option value="<?= $distribuidor->getId() ?>"><?= $distribuidor->getEndereco() ?></option>
                                    <?php endif ?>
                                <?php endforeach ?>
                            </select>
