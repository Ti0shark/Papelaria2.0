                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="nome_produto" class="form-control" value="<?= $produto->getNome() ?>">
                        </p>
                        <p class="form-group">
                            <label for="quant_produto">Quantidade</label>
                            <input type="text" name="quant_produto" class="form-control" value="<?= $produto->getQuantidade() ?>">
                        </p>
                        <p class="form-group">
